...
func _process(delta: float) -> void:
	var amplitude = Globale.amplitude2
	var frequency = Globale.frequency2
	var offset_x = Globale.offset_x2
	var offeset_y = Globale.offset_y2
